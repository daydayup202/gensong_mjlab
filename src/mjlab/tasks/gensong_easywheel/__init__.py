from mjlab.tasks.gensong_easywheel.config.env_cfgs import (
  ...
  gensong_easywheel_flat_switch_env_cfg,
)
...
register_mjlab_task(
  task_id="Mjlab-Gensong-EasyWheel-Flat-Switch-2W",
  env_cfg=gensong_easywheel_flat_switch_env_cfg(),
  play_env_cfg=gensong_easywheel_flat_switch_env_cfg(play=True),
  rl_cfg=gensong_easywheel_ppo_runner_cfg(),
)
